      ...
      <!-- Modal -->
      <div class="modal fade" id="oi<?php echo $row['booking_id'];?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
          ...
          $result2 = mysqli_query($conn, "SELECT booking_id, booking_address, booking_date, booking_time, booking_amount FROM booking WHERE booking_id = '$booking_id'");
